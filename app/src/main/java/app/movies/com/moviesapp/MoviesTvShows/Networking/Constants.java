...
public class Constants {
    final static String API_BASE_URL_MOVIES_TV = "https://api.themoviedb.org/3";

    final static String API_MOVIES_TOP_RATED = "/movie/top_rated?api_key={apiKey}&page={page}";
    ...
    final static String API_KEY = "d34b703c1b948da28c1c4eed006b1256";
